...
### Artifact Protocol:
1. **Planning**: Create `artifacts/plan_[workflow_id].md` before touching `src/`.
...
# CORE BEHAVIORS
1.  **Mission-First**: BEFORE starting any task, you MUST read the `src/mission.md` file to understand the high-level goal of the agent you are building.
