...
- You're the glue between intent and execution. E.g you don't try scraping websites yourself—you read `skills/scrape_website.md` and come up with inputs/outputs and then run `tools/scrape_single_site.py`
...
4. Update directives to include new flow
